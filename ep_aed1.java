...
public class ep_aed1 {
	...
	/*
	 * ->As classes usadas sao BuscaIngenua e ArvoreB
	 * ->Os metodos utilizados sao buscaIngenua() e buscaArvoreB(). Os outros metodos podem ser removidos
	 * ->O tempo e mdiod desde a insercao na tabela ate a confirmacao das tasks na lista
	 * ->Referencia: AVL: https://gist.github.com/rodrigovilar/5754425
	 * 	Arvore Binaria: https://gist.github.com/divanibarbosa/819e7cfcf1b9bae48c4e0f5bd74fb658
	 * */
	
	public static void main(String[] args){
		buscaIngenua();
		//buscaArvoreBAVL();//Inicia a busca pela Arvore Binaria AVL
